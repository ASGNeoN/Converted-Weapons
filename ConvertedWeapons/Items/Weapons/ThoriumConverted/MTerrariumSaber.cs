...
{
	public class MTerrariumSaber : ModItem
	{
        ...
        public override void SetStaticDefaults()
        {
            if (Thorium != null)
            {
                DisplayName.SetDefault("Terrarium Saber");
            }
            else
            {
                DisplayName.SetDefault("Terrarium Saber");
        ...
        public override void SetDefaults()
        {
            if (Thorium != null)
            {
                item.CloneDefaults(ModLoader.GetMod("ThoriumMod").ItemType("TerrariumSaber"));
                item.melee = false;
                item.magic = true;
                item.mana = 15;
                item.damage = 100;
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModLoader.GetMod("ThoriumMod").ItemType("TerrariumSaber"));
