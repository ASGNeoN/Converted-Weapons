...
{
	public class MRocketFist : ModItem
	{
        ...
        public override void SetStaticDefaults()
        {
            if (Thorium != null)
            {
                DisplayName.SetDefault("Rocket Fist");
            }
            else
            {
                DisplayName.SetDefault("Rocket Fist");
        ...
        public override void SetDefaults()
        {
            if (Thorium != null)
            {
                item.CloneDefaults(ModLoader.GetMod("ThoriumMod").ItemType("RocketFist"));
                item.melee = false;
                item.thrown = false;
                item.ranged = false;
                item.magic = true;
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModLoader.GetMod("ThoriumMod").ItemType("RocketFist"));
