...
{
	public class MEssenceofFlame : ModItem
	{
        ...
        public override void SetStaticDefaults()
        {
            if (Thorium != null)
            {
                DisplayName.SetDefault("Essence of Flame");
            }
            else
            {
                DisplayName.SetDefault("Essence of Flame");
        ...
        public override void SetDefaults()
        {
            if (Thorium != null)
            {
                item.CloneDefaults(ModLoader.GetMod("ThoriumMod").ItemType("EssenceofFlame"));
                item.melee = false;
                item.magic = true;
                item.mana = 15;
                item.damage = 150;
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModLoader.GetMod("ThoriumMod").ItemType("EssenceofFlame"));
