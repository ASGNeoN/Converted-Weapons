...
{
	public class MBlackBlade : ModItem
	{
        ...
        public override void SetStaticDefaults()
        {
            if (Thorium != null)
            {
                DisplayName.SetDefault("The Black Blade");
            }
            else
            {
                DisplayName.SetDefault("The Black Blade");
        ...
        public override void SetDefaults()
        {
            if (Thorium != null)
            {
                item.CloneDefaults(ModLoader.GetMod("ThoriumMod").ItemType("BlackBlade"));
                item.melee = false;
                item.magic = true;
                item.mana = 15;
                item.damage = 60;
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModLoader.GetMod("ThoriumMod").ItemType("BlackBlade"));
