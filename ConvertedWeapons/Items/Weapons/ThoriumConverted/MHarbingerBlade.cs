...
{
	public class MHarbingerBlade : ModItem
	{
        ...
        public override void SetStaticDefaults()
        {
            if (Thorium != null)
            {
                DisplayName.SetDefault("Harbinger Blade");
            }
            else
            {
                DisplayName.SetDefault("Harbinger Blade");
        ...
        public override void SetDefaults()
        {
            if (Thorium != null)
            {
                item.CloneDefaults(ModLoader.GetMod("ThoriumMod").ItemType("HarbingerBlade"));
                item.magic = false;
                item.melee = true;
                item.mana = 0;
                item.damage = 70;
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModLoader.GetMod("ThoriumMod").ItemType("HarbingerBlade"));
