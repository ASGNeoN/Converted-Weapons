...
{
	public class MDemonBloodSword : ModItem
	{
        ...
        public override void SetStaticDefaults()
        {
            if (Thorium != null)
            {
                DisplayName.SetDefault("Demon Blood Sword");
            }
            else
            {
                DisplayName.SetDefault("Demon Blood Sword");
        ...
        public override void SetDefaults()
        {
            if (Thorium != null)
            {
                item.CloneDefaults(ModLoader.GetMod("ThoriumMod").ItemType("DemonBloodSword"));
                item.melee = false;
                item.magic = true;
                item.mana = 20;
                item.damage = 60;
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModLoader.GetMod("ThoriumMod").ItemType("DemonBloodSword"));
