...
{
	public class TSchmelze : ModItem
	{
        ...
        public override void SetStaticDefaults()
        {
            if (Thorium != null)
            {
                DisplayName.SetDefault("Schmelze");
            }
            else
            {
                DisplayName.SetDefault("Schmelze");
        ...
        public override void SetDefaults()
        {
            if (Thorium != null)
            {
                item.CloneDefaults(ModLoader.GetMod("ThoriumMod").ItemType("Schmelze"));
                item.melee = false;
                item.thrown = true;
                item.autoReuse = true;
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModLoader.GetMod("ThoriumMod").ItemType("Schmelze"));
