...
{
	public class MTitanSword : ModItem
	{
        ...
        public override void SetStaticDefaults()
        {
            if (Thorium != null)
            {
                DisplayName.SetDefault("Titan Sword");
            }
            else
            {
                DisplayName.SetDefault("Titan Sword");
        ...
        public override void SetDefaults()
        {
            if (Thorium != null)
            {
                item.CloneDefaults(ModLoader.GetMod("ThoriumMod").ItemType("TitanSword"));
                item.melee = false;
                item.magic = true;
                item.mana = 15;
                item.damage = 44;
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModLoader.GetMod("ThoriumMod").ItemType("TitanSword"));
